		...
		<div class="main">
			...
			<div class="bd">
				<div class="img_detail">
					<p class="tit"><?php echo $img['c_title']; ?></p>
					<div class="info clearfix">
						<div class="pic"><img src="<?php echo $img['imgurls']; ?>" /></div>
					</div>
					<div class="content"><?php echo $img['c_content']; ?></div>
					<div class="hits">
					点击数：
					更新时间：<?php echo $img['updatetime']; ?>&nbsp;
					<a href="">[打印此页]</a>
					<a href="">[关闭]</a>
				</div>
				</div>
