					...
					<ul>
						...
						<li class="clearfix">
							<div class="info fl">
								...
								<span class="position">
									招聘职位：<a href="<?php echo $val['c_url']; ?>" target="_blank"><?php echo $val['c_position']; ?></a>
								</span>
								<span class="count">招聘人数：<?php echo $val['count']; ?></span>
								<span class="date">发布日期：<?php echo $val['addtime']; ?></span>
							</div>
							<div class="detail fr">
