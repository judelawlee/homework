		...
		<tr>
			...
			<td valign="top">
				<div class="index_set main">
					<div class="hd"><b>添加下载中心</b></div>
					<form class="bd" method="post" action="" name="index_set">
						<input type="hidden" name="action" value="modify" />
						<table>
							<tr>
								<td><b><font color="#f00">*</font>文件标题：</b></td>
							...
							<tr>
								<td><b><font color="#f00">*</font>下载地址：</b></td>
								<td>
									<input type="file" name="web_online_type" value="" />
									<input type="submit" name="web_online_type" value="上传" class="tj" />
								</td>
							</tr>
							<tr>
								<td><b>文件大小：</b></td>
								<td>
									<input type="text" size="10" name="web_online_type" value="" />K
								</td>
							</tr>
							<?php
